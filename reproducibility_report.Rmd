...
The session information, including R version, platform, and loaded packages.

```{r session-info-detailed}
# sessioninfo provides more detailed session information
